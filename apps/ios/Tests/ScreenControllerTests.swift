...
@Suite struct ScreenControllerTests {
    ...
    @Test @MainActor func localNetworkCanvasURLsAreAllowed() {
        let screen = ScreenController()
        #expect(screen.isLocalNetworkCanvasURL(URL(string: "http://localhost:40104/")!) == true)
        #expect(screen.isLocalNetworkCanvasURL(URL(string: "http://openclaw.local:40104/")!) == true)
        #expect(screen.isLocalNetworkCanvasURL(URL(string: "http://peters-mac-studio-1:40104/")!) == true)
        #expect(screen.isLocalNetworkCanvasURL(URL(string: "https://peters-mac-studio-1.ts.net:40104/")!) == true)
        #expect(screen.isLocalNetworkCanvasURL(URL(string: "http://192.168.0.10:40104/")!) == true)
        #expect(screen.isLocalNetworkCanvasURL(URL(string: "http://10.0.0.10:40104/")!) == true)
        #expect(screen.isLocalNetworkCanvasURL(URL(string: "http://100.123.224.76:40104/")!) == true) // Tailscale CGNAT
